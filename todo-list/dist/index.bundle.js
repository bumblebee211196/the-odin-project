...
class Task {
  constructor(name, description, dueDate, priority) {
    ...
    this.createdDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'yyyy-MM-dd');
  }
}
...
class TaskList {
  ...
  static getItemCard(task) {
    ...
    deleteButton.addEventListener('click', (e) => {
      ...
      const taskId = parentDiv.dataset.key;
      console.log(taskId);
      this.removeTask(_todo__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectId(), taskId);
      console.log(_todo__WEBPACK_IMPORTED_MODULE_0__["default"].getTodo()[_todo__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectId()]['tasks']);
