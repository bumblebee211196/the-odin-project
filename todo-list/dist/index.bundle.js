...
class ProjectList {
  ...
  static getItemCard(project) {
    ...
    deleteButton.addEventListener('click', (e) => {
      ...
      this.updateItemList();
      _task__WEBPACK_IMPORTED_MODULE_0__["default"].updateItemList();
    });
...
class Task {
  constructor(name, description, dueDate, priority) {
    ...
    this.createdDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'dd-MM-yyyy');
  }
}
...
class TaskList {
  ...
  static getItemCard(task) {
    ...
    editButton.addEventListener('click', (e) => {
      ...
      this.openUpdatePopupForm(_todo__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectId(), taskId, parentDiv)
    });
  ...
  static openUpdatePopupForm(projectId, taskId, taskElement) {
    ...
    submitButton.addEventListener('click', (e) => {
      ...
      this.updateItemList(_todo__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectId());
    });
